...
import com.timvisee.worldportal.command.CommandPermissions;
import com.timvisee.worldportal.util.StringUtils;
...
public class HelpPrinter {
    ...
    public static void printPermissions(CommandSender sender, CommandDescription command) {
        ...
        for(String node : permissions.getPermissionNodes()) {
            ...
            if(sender instanceof Player)
                nodePermission = WorldPortal.instance.getPermissionsManager().hasPermission((Player) sender, node, false);
    ...
    public static void printAlternatives(CommandSender sender, CommandDescription command, CommandParts commandReference) {
        ...
        Collections.sort(alternatives, Comparator.comparingDouble(o -> StringUtils.getDifference(usedLabel, o)));
